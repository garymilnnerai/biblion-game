...
const DB = [
  ...
  // PREGUNTAS 101-300
  { id:101, cat:"Personas", q:"¿Quién fue el profeta que anunció una hambruna de 7 años al faraón según Génesis 41?", hints:["Interpretó los sueños del faraón","Había estado en prisión antes","Era hijo de Jacob"], a:"José" },
  { id:102, cat:"Personas", q:"¿Quién fue la esposa de Isaac y madre de Jacob y Esaú según Génesis 24?", hints:["Era de Mesopotamia","Abraham envió a su siervo a buscarla","Su nombre aparece en Génesis 24"], a:"Rebeca" },
  { id:103, cat:"Personas", q:"¿Quién fue el profeta que confrontó al rey Acab por la viña de Nabot según 1 Reyes 21?", hints:["Anunció que los perros lamerían su sangre","Era el profeta de fuego","Su sucesor fue Eliseo"], a:"Elías" },
  { id:104, cat:"Personas", q:"¿Quién fue el primer sumo sacerdote de Israel según Éxodo 28?", hints:["Era hermano de Moisés","Su vara floreció milagrosamente","Dios lo designó para el sacerdocio"], a:"Aarón" },
  { id:105, cat:"Personas", q:"¿Quién fue el hijo de Jacob que perdió su primogenitura por yacer con la concubina de su padre según Génesis 49?", hints:["Jacob se la quitó en su bendición final","Era el mayor de los 12 hijos","Su nombre empieza con R"], a:"Rubén" },
  { id:106, cat:"Personas", q:"¿Quién fue el profeta que fue comido por un gran pez según Jonás 1?", hints:["Huyó hacia Tarsis en un barco","Estuvo 3 días en el vientre del pez","Predicó en Nínive"], a:"Jonás" },
  { id:107, cat:"Personas", q:"¿Quién fue el rey de Judá que hizo lo recto ante Dios y quitó la serpiente de bronce según 2 Reyes 18?", hints:["Quitó la serpiente de bronce que había hecho Moisés","Un ángel mató 185,000 asirios en su tiempo","Su nombre empieza con Ez"], a:"Ezequías" },
  { id:108, cat:"Personas", q:"¿Quién fue el profeta que vio la visión de los huesos secos según Ezequiel 37?", hints:["Dios le preguntó si podían vivir esos huesos","Profetizó sobre ellos y los huesos revivieron","Era el profeta del exilio babilónico"], a:"Ezequiel" },
  { id:109, cat:"Personas", q:"¿Quién fue el rey asirio que invadió Judá en tiempos de Ezequías según 2 Reyes 18?", hints:["Envió a Rabsaces a hablar contra Jehová","Un ángel mató 185,000 de su ejército","Su nombre empieza con Sen"], a:"Senaquerib" },
  { id:110, cat:"Personas", q:"¿Quién fue el rey de Babilonia que convirtió a Daniel en gobernador según Daniel 2?", hints:["Daniel interpretó su sueño de la gran estatua","El rey se postró ante Daniel después","Su nombre empieza con N y es largo"], a:"Nabucodonosor" },
  { id:111, cat:"Lugares", q:"¿En qué ciudad fue bautizado Jesús según Mateo 3?", hints:["Juan el Bautista lo bautizó allí","El Espíritu Santo descendió como paloma","Era el río que dividía Israel de Jordania"], a:"Río Jordán" },
  { id:112, cat:"Lugares", q:"¿En qué ciudad fue criado Pablo según Hechos 22?", hints:["Era en Asia Menor","Era una ciudad importante de Cilicia","Pablo dijo que era ciudadano de esa ciudad no pequeña"], a:"Tarso de Cilicia" },
  { id:113, cat:"Lugares", q:"¿En qué isla escribió Juan el Apocalipsis según Apocalipsis 1?", hints:["Estaba allí por causa de la palabra de Dios","Era una isla en el Mar Egeo","Su nombre empieza con P"], a:"Patmos" },
  { id:114, cat:"Lugares", q:"¿En qué estanque Jesús sanó al paralítico de 38 años según Juan 5?", hints:["Tenía cinco pórticos","Allí yacía una multitud de enfermos","Su nombre empieza con B"], a:"Betesda" },
  { id:115, cat:"Lugares", q:"¿En qué ciudad ocurrió el primer milagro de Jesús según Juan 2?", hints:["Era en Galilea","Había una boda allí","Su nombre empieza con C"], a:"Caná de Galilea" },
  { id:116, cat:"Lugares", q:"¿En qué monte fue detenido Abraham cuando iba a sacrificar a Isaac según Génesis 22?", hints:["Dios proveyó un carnero en su lugar","Abraham llamó al lugar Jehová Jireh","Está en la tierra de Moriah"], a:"Monte Moriah" },
  { id:117, cat:"Lugares", q:"¿En qué ciudad fue apedreado Pablo y dado por muerto según Hechos 14?", hints:["Era en la región de Licaonia","Antes los habitantes lo habían querido adorar como un dios","Su nombre empieza con L"], a:"Listra" },
  { id:118, cat:"Lugares", q:"¿En qué lugar fue enterrado Moisés según Deuteronomio 34?", hints:["Nadie sabe exactamente dónde está su tumba","Era en la tierra de Moab","Frente a Bet-peor"], a:"En la tierra de Moab frente a Bet-peor" },
  { id:119, cat:"Lugares", q:"¿En qué ciudad fue convertido Saulo de Tarso según Hechos 9?", hints:["Iba de camino a perseguir cristianos","Una luz del cielo lo derribó","El Señor le habló y quedó ciego tres días"], a:"Camino a Damasco" },
  { id:120, cat:"Lugares", q:"¿En qué ciudad nació Abraham según Génesis 11?", hints:["Era una ciudad en Mesopotamia","Su familia vivía allí antes de salir","Su nombre completo era Ur de los Caldeos"], a:"Ur de los Caldeos" },
  { id:121, cat:"Números", q:"¿Cuántos años vivió Abraham según Génesis 25?", hints:["Tuvo a Isaac cuando tenía 100 años","Murió en buena vejez","Vivió 175 años"], a:"175 años" },
  { id:122, cat:"Números", q:"¿Cuántos años tenía Caleb cuando pidió la tierra de Hebrón según Josué 14?", hints:["Tenía 40 años cuando fue espía","Habían pasado 45 años desde entonces","Tenía 85 años cuando pidió la montaña"], a:"85 años" },
  { id:123, cat:"Números", q:"¿Cuántos años tardó Salomón en construir su palacio según 1 Reyes 7?", hints:["Tardó más en construir su palacio que el templo","El templo tardó 7 años","Su palacio tardó 13 años"], a:"13 años" },
  { id:124, cat:"Números", q:"¿Cuántos libros tiene el Antiguo Testamento?", hints:["El Nuevo Testamento tiene 27","Juntos suman 66","El número es 39"], a:"39 libros" },
  { id:125, cat:"Números", q:"¿Cuántos años tardó Salomón en construir el templo según 1 Reyes 6?", hints:["Comenzó a construirlo en el cuarto año de su reinado","Lo terminó en el undécimo año","El número de años es 7"], a:"7 años" },
  { id:126, cat:"Números", q:"¿Cuántos capítulos tiene el libro de Isaías?", hints:["Es el mismo número que los libros de la Biblia","La Biblia tiene 66 libros","El libro de Isaías tiene 66 capítulos"], a:"66 capítulos" },
  { id:127, cat:"Números", q:"¿Cuántos hijos e hijas perdió Job en un solo día según Job 1?", hints:["Todos murieron cuando la casa colapsó","Eran 7 hijos y 3 hijas","El total es 10 hijos"], a:"10 hijos (7 varones y 3 mujeres)" },
  { id:128, cat:"Números", q:"¿Cuántos peces pescaron los discípulos en la pesca milagrosa después de la resurrección según Juan 21?", hints:["Jesús les dijo que echaran la red al lado derecho","No podían sacar la red por la cantidad","El número exacto es 153"], a:"153 peces" },
  { id:129, cat:"Números", q:"¿Cuántos años vivió Noé según Génesis 9?", hints:["Vivió más de 900 años","El diluvio ocurrió cuando tenía 600 años","Vivió 350 años después del diluvio"], a:"950 años" },
  { id:130, cat:"Números", q:"¿Cuánto tiempo duró la sequía anunciada por Elías según Santiago 5?", hints:["Santiago lo menciona como ejemplo de oración eficaz","Elías era un hombre como nosotros","Duró tres años y seis meses"], a:"3 años y 6 meses" },
  { id:131, cat:"Animales", q:"¿Cuántos pares de animales impuros entró Noé en el arca según Génesis 7?", hints:["Los animales puros entraron en grupos de siete","Los impuros entraron de dos en dos","El número de pares de animales impuros era uno"], a:"1 par (2 de cada especie impura)" },
  { id:132, cat:"Animales", q:"¿Qué animal usó Sansón para incendiar los campos de los filisteos según Jueces 15?", hints:["Capturó 300 de ellos","Les ató antorchas en las colas","Las soltó en los sembradíos"], a:"Zorras (o chacales)" },
  { id:133, cat:"Animales", q:"¿Qué tipo de animales le envió Dios a Elías para alimentarlo en el arroyo de Querit según 1 Reyes 17?", hints:["Le traían pan y carne por la mañana y por la tarde","El arroyo se llamaba Querit","Eran aves negras"], a:"Cuervos" },
  { id:134, cat:"Animales", q:"¿Qué animal encontró Pedro con una moneda en la boca según Mateo 17?", hints:["Jesús le dijo que fuera al mar y echara el anzuelo","El primer pez que sacara la tendría","Era un pez del Mar de Galilea"], a:"Un pez con una moneda en la boca" },
  { id:135, cat:"Animales", q:"¿En qué animales entraron los demonios llamados Legión según Marcos 5?", hints:["Los demonios pedían no ser enviados al abismo","Se lanzaron por un precipicio al mar","Eran animales que Israel no comía"], a:"Cerdos" },
  { id:136, cat:"Animales", q:"¿Qué tipo de animales enviaron los filisteos con el arca del pacto al devolverla según 1 Samuel 6?", hints:["Eran hembras que nunca habían sido uncidas","Jalaron el carro sin haber sido amaestradas","Eran vacas que amamantaban a sus crías"], a:"Vacas que criaban" },
  { id:137, cat:"Animales", q:"¿En qué animal entró Jesús a Jerusalén según Mateo 21?", hints:["Era un animal humilde","Se cumplió una profecía de Zacarías","Es un animal de carga muy paciente"], a:"Un asno" },
  { id:138, cat:"Plantas", q:"¿De qué árbol tomaron hojas Adán y Eva para cubrirse según Génesis 3?", hints:["Usaron sus hojas para hacerse delantales","Es un árbol de fruta conocida","Sus hojas son grandes y anchas"], a:"La higuera" },
  { id:139, cat:"Plantas", q:"¿Con qué planta protegió Dios a Jonás del sol según Jonás 4?", hints:["Creció en una noche sobre Jonás","Jonás se alegró mucho por ella","Al día siguiente Dios preparó un gusano que la atacó"], a:"Una calabacera o planta enredadera" },
  { id:140, cat:"Plantas", q:"¿Qué árbol usó Elías para descansar cuando huyó de Jezabel según 1 Reyes 19?", hints:["Se sentó bajo su sombra y pidió morir","Un ángel lo tocó y le dio de comer","Es un árbol del desierto"], a:"Un enebro" },
  { id:141, cat:"Plantas", q:"¿Con qué hicieron a Moisés un cesto para ponerlo en el Nilo según Éxodo 2?", hints:["Era una planta que crece a la orilla del río","También se usa para hacer papel","Su nombre es papiro en griego"], a:"Juncos (papiro)" },
  { id:142, cat:"Plantas", q:"¿Qué pasó con la higuera que Jesús maldijo según Mateo 21?", hints:["No tenía frutos aunque tenía hojas","Jesús la maldijo al no encontrar fruto","Al día siguiente estaba completamente seca"], a:"Se secó desde las raíces" },
  { id:143, cat:"Plantas", q:"¿Con qué tipo de planta fue fabricada la corona que pusieron a Jesús según Juan 19?", hints:["Era una planta con pinchos","La pusieron en su cabeza para burlarse","Es símbolo del sufrimiento de Cristo"], a:"Espinas (corona de espinas)" },
  { id:144, cat:"Objetos", q:"¿Con qué objeto mató Jael al general Sísara según Jueces 4?", hints:["Era un instrumento de construcción","Lo clavó en la sien de Sísara mientras dormía","Era una estaca de tienda de campaña"], a:"Una estaca de tienda y un mazo" },
  { id:145, cat:"Objetos", q:"¿Qué instrumento musical usó María para celebrar el cruce del Mar Rojo según Éxodo 15?", hints:["Era un instrumento de percusión","María tomó este instrumento y dirigió a las mujeres","Es un instrumento que se toca con las manos"], a:"La pandereta" },
  { id:146, cat:"Objetos", q:"¿Con qué hilo especial marcó Rahab su ventana para ser salvada según Josué 2?", hints:["Los espías le dijeron que lo colgara","El color es símbolo de sangre y redención","Era un cordón de color rojo escarlata"], a:"Cordón de grana (hilo rojo escarlata)" },
  { id:147, cat:"Objetos", q:"¿Cuántos brazos tenía el candelero de oro del tabernáculo según Éxodo 25?", hints:["Iluminaba el lugar santo del tabernáculo","Es símbolo del Estado de Israel hoy","El número de brazos era 7"], a:"7 brazos (el menorá)" },
  { id:148, cat:"Objetos", q:"¿Qué se guardaba en el Lugar Santísimo del tabernáculo según Éxodo 26?", hints:["Solo el sumo sacerdote podía entrar una vez al año","Estaba separado por un velo","Allí estaba el Arca del Pacto"], a:"El Arca del Pacto" },
  { id:149, cat:"Objetos", q:"¿Qué ungió la mujer sobre Jesús en casa de Simón el leproso según Mateo 26?", hints:["Era muy costoso","Lo derramó sobre la cabeza de Jesús","Los discípulos se enojaron por el gasto"], a:"Perfume muy caro en frasco de alabastro" },
  { id:150, cat:"Objetos", q:"¿Qué símbolo instituyó Jesús en la última cena según Mateo 26?", hints:["Tomó el pan y lo partió","También tomó la copa","Le llamó el nuevo pacto en su sangre"], a:"El pan y la copa (la Cena del Señor)" },
  { id:151, cat:"Eventos", q:"¿Qué ocurrió con los tres amigos de Daniel en el horno de fuego según Daniel 3?", hints:["El rey lo había calentado siete veces más","El rey vio a un cuarto personaje en el horno","Salieron sin que su ropa oliera a humo"], a:"Salieron ilesos y sin olor a humo" },
  { id:152, cat:"Eventos", q:"¿Qué pasó cuando Jesús calmó la tormenta según Marcos 4?", hints:["Los discípulos estaban atemorizados en la barca","Jesús estaba dormido en la popa","Reprendió al viento y dijo: calla enmudece"], a:"El viento cesó y hubo gran bonanza" },
  { id:153, cat:"Eventos", q:"¿Qué ocurrió en la Transfiguración de Jesús según Mateo 17?", hints:["Ocurrió en un monte alto","Su rostro resplandeció como el sol","Aparecieron Moisés y Elías hablando con él"], a:"Jesús se transfiguró: su rostro brilló y aparecieron Moisés y Elías" },
  { id:154, cat:"Eventos", q:"¿Qué le pasó a la mujer de Lot según Génesis 19?", hints:["Estaban huyendo de Sodoma","Dios había ordenado no mirar atrás","Se convirtió en estatua de sal"], a:"Se convirtió en estatua de sal" },
  { id:155, cat:"Eventos", q:"¿Qué ocurrió cuando Elías oró en el Monte Carmelo según 1 Reyes 18?", hints:["Había empapado el altar con agua tres veces","Los profetas de Baal no pudieron encender fuego","El fuego de Dios consumió el holocausto el agua y hasta las piedras"], a:"El fuego de Dios consumió todo el altar" },
  { id:156, cat:"Eventos", q:"¿Qué dijo la voz del cielo cuando Jesús fue bautizado según Mateo 3?", hints:["El Espíritu Santo bajó como paloma","El Padre habló desde el cielo","Dijo: este es mi Hijo amado en quien tengo complacencia"], a:"Este es mi Hijo amado en quien tengo complacencia" },
  { id:157, cat:"Eventos", q:"¿Qué sucedió con el sol cuando Josué peleó contra los amorreos según Josué 10?", hints:["Josué habló al sol y a la luna","No hubo día semejante antes ni después","El sol se detuvo en medio del cielo"], a:"El sol se detuvo" },
  { id:158, cat:"Eventos", q:"¿Qué le ocurrió a Uzías rey de Judá por entrar al templo según 2 Crónicas 26?", hints:["El sacerdote Azarías y 80 sacerdotes lo confrontaron","Le salió lepra en la frente","Vivió como leproso hasta el día de su muerte"], a:"Le salió lepra en la frente" },
  { id:159, cat:"Eventos", q:"¿Qué ocurrió cuando Josué marchó alrededor de Jericó según Josué 6?", hints:["Marcharon durante 7 días","El séptimo día marcharon 7 veces","Al sonar las trompetas y gritar el pueblo los muros cayeron"], a:"Los muros de Jericó cayeron" },
  { id:160, cat:"Eventos", q:"¿Qué hizo Naamán para ser sanado de lepra según 2 Reyes 5?", hints:["Al principio se negó porque esperaba algo más espectacular","Eliseo le mandó bañarse en el Jordán","Se bañó 7 veces y su piel quedó como la de un niño"], a:"Se bañó 7 veces en el río Jordán y fue sanado" },
  { id:161, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años vivió Matusalén según Génesis 5?", hints:["Es el hombre más longevo de la Biblia","Vivió más de 900 años","El número exacto es 969"], a:"969 años" },
  { id:162, cat:"Desafío", q:"⚡ DESAFÍO: ¿En qué versículo dice: En el principio era el Verbo?", hints:["Es el comienzo del evangelio de Juan","El Verbo estaba con Dios y era Dios","Es Juan capítulo 1 versículo 1"], a:"Juan 1:1" },
  { id:163, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años reinó Manasés rey de Judá según 2 Reyes 21?", hints:["Era hijo del rey Ezequías","Hizo más mal que los amorreos","Reinó 55 años"], a:"55 años" },
  { id:164, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años llevaba enferma la mujer encorvada que Jesús sanó en la sinagoga según Lucas 13?", hints:["Un espíritu de enfermedad la tenía encorvada","No podía enderezarse de ninguna manera","Llevaba 18 años enferma"], a:"18 años" },
  { id:165, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos frutos del Espíritu enumera Pablo en Gálatas 5?", hints:["Son 9 frutos en total","Comienzan con amor gozo paz","Terminan con templanza o dominio propio"], a:"9 frutos: amor, gozo, paz, paciencia, benignidad, bondad, fe, mansedumbre, templanza" },
  { id:166, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántas veces rodearon Jericó en total durante los 7 días según Josué 6?", hints:["Los primeros 6 días rodearon una vez cada día","El séptimo día rodearon 7 veces","El total es 6 más 7 igual 13"], a:"13 veces en total" },
  { id:167, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años tardó Salomón en construir su palacio según 1 Reyes 7?", hints:["Tardó más en construir su palacio que el templo","El templo tardó 7 años","Su palacio tardó 13 años"], a:"13 años" },
  { id:168, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos capítulos tiene el libro de Apocalipsis?", hints:["Es el último libro de la Biblia","Contiene las 7 cartas a las iglesias","El número es 22"], a:"22 capítulos" },
  { id:169, cat:"Personas", q:"¿Quién fue la profetisa y hermana de Moisés mencionada en Éxodo 15?", hints:["Tomó una pandereta y dirigió a las mujeres en canto","Fue herida de lepra por murmurar contra Moisés","Su nombre empieza con M"], a:"María (Miriam)" },
  { id:170, cat:"Personas", q:"¿Quién fue el suegro de Moisés que le aconsejó delegar la justicia según Éxodo 18?", hints:["Era sacerdote de Madián","Le dijo que el trabajo era demasiado para uno solo","Su nombre empieza con J"], a:"Jetro" },
  { id:171, cat:"Personas", q:"¿Quién fue el médico que escribió el evangelio de Lucas según Colosenses 4?", hints:["Pablo lo menciona como médico amado","Escribió también el libro de Hechos","Era compañero de viaje de Pablo"], a:"Lucas" },
  { id:172, cat:"Personas", q:"¿Quién era Lidia según Hechos 16?", hints:["Era de la ciudad de Tiatira","Vendía púrpura","El Señor abrió su corazón para que prestara atención a Pablo"], a:"Vendedora de púrpura de Tiatira, primera convertida en Filipos" },
  { id:173, cat:"Personas", q:"¿Quién era el ángel que anunció el nacimiento de Jesús a María según Lucas 1?", hints:["También anunció el nacimiento de Juan el Bautista a Zacarías","Aparece también en Daniel","Su nombre significa fuerza de Dios"], a:"Gabriel" },
  { id:174, cat:"Personas", q:"¿Quién fue la madre de Juan el Bautista según Lucas 1?", hints:["Era parienta de María la madre de Jesús","Estaba avanzada en años cuando quedó embarazada","Su nombre empieza con E"], a:"Elisabet" },
  { id:175, cat:"Personas", q:"¿Quién era Nicodemo según Juan 3?", hints:["Era fariseo y principal entre los judíos","Fue a ver a Jesús de noche","Jesús le habló del nuevo nacimiento"], a:"Un fariseo que visitó a Jesús de noche" },
  { id:176, cat:"Personas", q:"¿Quién fue el padre de Juan el Bautista según Lucas 1?", hints:["Era sacerdote del orden de Abías","Quedó mudo por no creer al ángel Gabriel","Su nombre empieza con Z"], a:"Zacarías" },
  { id:177, cat:"Personas", q:"¿Quién era María Magdalena según los evangelios?", hints:["Jesús expulsó 7 demonios de ella según Lucas 8","Fue al sepulcro el primer día de la semana","Fue la primera en ver a Jesús resucitado según Juan 20"], a:"Mujer de Magdala de quien Jesús expulsó 7 demonios" },
  { id:178, cat:"Personas", q:"¿Quién fue el profeta que ungió a Jehú como rey de Israel según 2 Reyes 9?", hints:["Era sucesor de Elías","Envió a un joven profeta a realizar la unción","Su nombre empieza con E como su maestro pero diferente"], a:"Eliseo" },
  { id:179, cat:"Personas", q:"¿Quién fue el sacerdote que crió al niño Samuel en el tabernáculo de Silo según 1 Samuel 1?", hints:["Tenía dos hijos muy malvados Ofni y Finees","Murió al caer de su silla cuando supo que el arca fue capturada","Su nombre empieza con E"], a:"Elí" },
  { id:180, cat:"Personas", q:"¿Quién fue el discípulo amado que estaba al pie de la cruz según Juan 19?", hints:["Jesús le encargó el cuidado de su madre","Era hijo de Zebedeo","Escribió el cuarto evangelio"], a:"Juan el apóstol" },
  { id:181, cat:"Números", q:"¿Cuántos años vivió Isaac según Génesis 35?", hints:["Vivió más que su padre Abraham","Enterró a su padre junto con su hermano Ismael","Vivió 180 años"], a:"180 años" },
  { id:182, cat:"Números", q:"¿Cuántos años tenía José cuando fue vendido por sus hermanos según Génesis 37?", hints:["Era joven cuando fue vendido","Después estuvo en la cárcel y ante el Faraón","Tenía 17 años cuando fue vendido"], a:"17 años" },
  { id:183, cat:"Números", q:"¿Cuántos días estuvo Saulo sin comer ni beber después de su conversión según Hechos 9?", hints:["Estaba en la calle llamada Derecha en Damasco","Quedó ciego durante ese tiempo","El número es tres"], a:"3 días" },
  { id:184, cat:"Números", q:"¿Cuántos años llevaba paralítico el hombre de Betesda cuando Jesús lo sanó según Juan 5?", hints:["Jesús le preguntó si quería ser sano","Dijo que no tenía quien lo metiera al agua","Llevaba 38 años enfermo"], a:"38 años" },
  { id:185, cat:"Números", q:"¿Cuántos demonios expulsó Jesús de María Magdalena según Lucas 8?", hints:["Era una mujer de Magdala","Seguía a Jesús y le servía","El número de demonios era 7"], a:"7 demonios" },
  { id:186, cat:"Números", q:"¿Cuántos años llevaba enferma la mujer del flujo de sangre según Lucas 8?", hints:["Había gastado todo en médicos sin sanar","Tocó el borde del manto de Jesús","El número es doce"], a:"12 años" },
  { id:187, cat:"Números", q:"¿Cuántas iglesias de Asia recibieron cartas en Apocalipsis 2 y 3?", hints:["El número corresponde a los 7 candeleros","La primera fue Éfeso","La última fue Laodicea"], a:"7 iglesias" },
  { id:188, cat:"Números", q:"¿Cuántos años reinó Salomón según 1 Reyes 11?", hints:["Comenzó a reinar muy joven","El reino se dividió después de su muerte","Reinó 40 años"], a:"40 años" },
  { id:189, cat:"Números", q:"¿Cuántas bienaventuranzas aparecen en el Sermón del Monte según Mateo 5?", hints:["Todas comienzan con bienaventurados","Hablan de los pobres en espíritu los mansos etc.","El número generalmente reconocido es 8"], a:"8 bienaventuranzas principales" },
  { id:190, cat:"Números", q:"¿Cuántos años estuvo el arca del pacto en casa de Abinadab antes de que David la trasladara según 1 Samuel 7?", hints:["La habían traído de los filisteos","Eleazar hijo de Abinadab la guardaba","Estuvo 20 años allí"], a:"20 años" },
  { id:191, cat:"Eventos", q:"¿Qué ocurrió cuando el Espíritu Santo descendió sobre Cornelio y su casa según Hechos 10?", hints:["Pedro estaba predicando","Los circuncisos que vinieron con Pedro se asombraron","Comenzaron a hablar en lenguas y a glorificar a Dios"], a:"Hablaron en lenguas y glorificaron a Dios" },
  { id:192, cat:"Eventos", q:"¿Qué dijo Pedro cuando Jesús le preguntó quién era Él según Mateo 16?", hints:["Fue en Cesarea de Filipo","Los discípulos habían dado otras respuestas antes","Pedro dijo: Tú eres el Cristo el Hijo del Dios viviente"], a:"Tú eres el Cristo el Hijo del Dios viviente" },
  { id:193, cat:"Eventos", q:"¿Qué le pasó a la hija de Jairo según Marcos 5?", hints:["Jairo era principal de la sinagoga","Le dijeron que ya había muerto","Jesús tomó su mano y dijo: talita cumi"], a:"Jesús la resucitó diciendo: talita cumi" },
  { id:194, cat:"Eventos", q:"¿Qué ocurrió tres días después de la crucifixión de Jesús según Mateo 28?", hints:["Las mujeres fueron al sepulcro el primer día de la semana","Un ángel había quitado la piedra","El sepulcro estaba vacío"], a:"Jesús resucitó de entre los muertos" },
  { id:195, cat:"Eventos", q:"¿Qué hizo Josías al encontrar el libro de la ley en el templo según 2 Reyes 22?", hints:["Lo mandó leer ante todo el pueblo","Rasgó sus vestiduras al escuchar las palabras","Renovó el pacto con Dios"], a:"Rasgó sus vestiduras y renovó el pacto" },
  { id:196, cat:"Eventos", q:"¿Qué le ocurrió a Coré y sus seguidores que se rebelaron contra Moisés según Números 16?", hints:["La tierra se abrió y los tragó vivos","Sus familias también fueron tragadas","Un fuego consumió a los 250 que ofrecían incienso"], a:"La tierra se abrió y los tragó vivos" },
  { id:197, cat:"Eventos", q:"¿Qué ocurrió cuando Pablo y Silas oraban en la cárcel de Filipos según Hechos 16?", hints:["Era a medianoche","Cantaban himnos y los presos los escuchaban","Un terremoto abrió las puertas y soltó las cadenas"], a:"Un terremoto sacudió la cárcel y las puertas se abrieron" },
  { id:198, cat:"Eventos", q:"¿Qué pasó con la vara de Aarón en el tabernáculo según Números 17?", hints:["Cada tribu dejó su vara en el tabernáculo","La vara de Aarón fue la única que revivió","Dio flores y almendras"], a:"Floreció y dio almendras" },
  { id:199, cat:"Eventos", q:"¿Qué hizo Gedeón para pedir señal a Dios según Jueces 6?", hints:["Pidió dos señales contrarias","Primera que el vellón esté mojado y el suelo seco","Segunda que el vellón esté seco y el suelo mojado"], a:"El vellón mojado con suelo seco y luego vellón seco con suelo mojado" },
  { id:200, cat:"Eventos", q:"¿Qué pasó con el joven Eutico que se quedó dormido en Troas según Hechos 20?", hints:["Pablo predicó hasta la medianoche","El joven cayó desde el tercer piso","Pablo se echó sobre él y lo abrazó"], a:"Cayó muerto del tercer piso y Pablo lo resucitó" },
  { id:201, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años vivió Sem hijo de Noé según Génesis 11?", hints:["Era hijo de Noé","De él desciende la línea que llega a Abraham","Vivió 600 años"], a:"600 años" },
  { id:202, cat:"Desafío", q:"⚡ DESAFÍO: ¿En qué versículo dice: Todo lo puedo en Cristo que me fortalece?", hints:["Está en la carta a los Filipenses","El capítulo es el 4","El versículo es el 13"], a:"Filipenses 4:13" },
  { id:203, cat:"Desafío", q:"⚡ DESAFÍO: ¿Quién fue el eunuco que rescató a Jeremías del cisterna según Jeremías 38?", hints:["Era un etíope servidor del rey","Bajó a Jeremías con sogas y trapos viejos","Su nombre empieza con Eb"], a:"Ebed-melec" },
  { id:204, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos hombres contó David en el censo de 2 Samuel 24?", hints:["Joab desaconsejó hacer el censo","En Israel había 800,000 y en Judá 500,000","El total fue 1,300,000"], a:"1,300,000 hombres" },
  { id:205, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años tenía Josías cuando comenzó a reinar según 2 Reyes 22?", hints:["Era muy joven cuando subió al trono","Comenzó a buscar a Dios en el octavo año de su reinado","Tenía 8 años cuando empezó a reinar"], a:"8 años" },
  { id:206, cat:"Personas", q:"¿Quién fue el rey de Israel que construyó la ciudad de Samaria según 1 Reyes 16?", hints:["Era padre del rey Acab","La compró por dos talentos de plata","La construyó sobre el cerro de Semer"], a:"Omri" },
  { id:207, cat:"Personas", q:"¿Quién fue el rey de Salem y sacerdote del Dios Altísimo según Génesis 14?", hints:["Salió a recibir a Abraham con pan y vino","Abraham le dio los diezmos de todo","No tiene genealogía registrada en el texto"], a:"Melquisedec" },
  { id:208, cat:"Personas", q:"¿Quién fue el profeta que anunció el Emanuel según Isaías 7?", hints:["Es el profeta más citado en el Nuevo Testamento","Anunció que una virgen concebiría","Su libro tiene 66 capítulos"], a:"Isaías" },
  { id:209, cat:"Personas", q:"¿Quién fue Cornelio según Hechos 10?", hints:["Era centurión romano","Era temeroso de Dios y daba limosnas","Pedro fue enviado a su casa a predicarle"], a:"Centurión romano temeroso de Dios en Cesarea" },
  { id:210, cat:"Personas", q:"¿Quién era Ananías que bautizó a Saulo en Damasco según Hechos 9?", hints:["El Señor se le apareció en visión","Le dijo que fuera a la calle llamada Derecha","Le puso las manos encima y Saulo recobró la vista"], a:"Un discípulo de Damasco llamado Ananías" },
  { id:211, cat:"Lugares", q:"¿En qué monte fue detenido Abraham cuando iba a sacrificar a Isaac?", hints:["Dios proveyó un carnero en su lugar","Abraham llamó al lugar Jehová Jireh","Está en la tierra de Moriah según Génesis 22"], a:"Monte Moriah" },
  { id:212, cat:"Lugares", q:"¿En qué ciudad reinó David los primeros 7 años según 2 Samuel 2?", hints:["Antes de trasladar su reinado a Jerusalén","Estaba en el territorio de Judá","Allí fue ungido rey de Judá"], a:"Hebrón" },
  { id:213, cat:"Lugares", q:"¿En qué lugar fue llamado Moisés por primera vez según Éxodo 3?", hints:["Estaba pastoreando el rebaño de su suegro","Vio una zarza que ardía y no se consumía","Dios le habló desde allí"], a:"Monte Horeb (Sinaí)" },
  { id:214, cat:"Lugares", q:"¿En qué ciudad nació el rey David según 1 Samuel 17?", hints:["También fue el lugar del nacimiento de Jesús","Era en Judea","Su nombre significa casa de pan"], a:"Belén" },
  { id:215, cat:"Lugares", q:"¿En qué ciudad predicó Jonás el arrepentimiento según Jonás 3?", hints:["Era la capital del Imperio Asirio","Tenía una extensión de tres días de camino","Todo el pueblo ayunó desde el rey hasta los animales"], a:"Nínive" },
  { id:216, cat:"Números", q:"¿Cuántos profetas de Baal desafió Elías en el Monte Carmelo según 1 Reyes 18?", hints:["También había 400 profetas de Asera","Elías estaba solo frente a todos ellos","El número de profetas de Baal era 450"], a:"450 profetas de Baal" },
  { id:217, cat:"Números", q:"¿Cuántos años tenía Abraham cuando nació Isaac según Génesis 21?", hints:["Sara tenía 90 años","Era humanamente imposible","El número es cien"], a:"100 años" },
  { id:218, cat:"Números", q:"¿Cuántos capítulos tiene el libro de los Salmos?", hints:["Es el libro más largo de la Biblia","El capítulo 119 es el más largo","El número de capítulos es 150"], a:"150 capítulos" },
  { id:219, cat:"Números", q:"¿Cuánto tiempo estuvo Israel en Egipto según Éxodo 12:40?", hints:["El número está entre 400 y 500","Dios le había dicho a Abraham que sus descendientes serían forasteros","El número exacto es 430"], a:"430 años" },
  { id:220, cat:"Números", q:"¿Cuántos siclos de plata pagaron los hermanos de José por venderlo según Génesis 37?", hints:["Los ismaelitas lo compraron","El número es veinte","Era el precio de un esclavo en aquella época"], a:"20 siclos de plata" },
  { id:221, cat:"Animales", q:"¿Qué animal habló con Balaam según Números 22?", hints:["Dios le abrió la boca para hablar","Vio al ángel del Señor antes que su amo","Era el animal que Balaam montaba"], a:"La asna de Balaam" },
  { id:222, cat:"Animales", q:"¿En qué forma descendió el Espíritu Santo cuando Jesús fue bautizado según Mateo 3?", hints:["Era una señal visible del cielo","El Padre habló en ese momento","Era un ave símbolo de paz"], a:"Como una paloma" },
  { id:223, cat:"Animales", q:"¿Qué animal tentó a Eva en el jardín del Edén según Génesis 3?", hints:["Dios lo maldijo por encima de todos los animales","Era el más astuto de los animales del campo","Le habló a Eva sobre el árbol prohibido"], a:"La serpiente" },
  { id:224, cat:"Plantas", q:"¿Desde qué tipo de planta habló Dios a Moisés según Éxodo 3?", hints:["Ardía y no se consumía","Dios habló desde ella","Estaba en el monte Horeb"], a:"La zarza ardiente" },
  { id:225, cat:"Plantas", q:"¿Qué árbol subió Zaqueo para ver a Jesús según Lucas 19?", hints:["Era un árbol de hoja perenne","Su nombre en latín es Ficus sycomorus","Zaqueo era bajo de estatura"], a:"El sicómoro" },
  { id:226, cat:"Plantas", q:"¿En qué tipo de planta comparó Jesús el reino de los cielos según Mateo 13?", hints:["Es la más pequeña de las semillas","Cuando crece se hace un árbol grande","Los pájaros hacen nidos en sus ramas"], a:"La semilla de mostaza" },
  { id:227, cat:"Objetos", q:"¿Qué contenía el Arca del Pacto según Hebreos 9?", hints:["Tres objetos sagrados estaban dentro","Uno era la vara que floreció","Otro era el maná guardado"], a:"Las tablas de la ley, la vara de Aarón y el maná" },
  { id:228, cat:"Objetos", q:"¿Con qué arma mató David al gigante Goliat según 1 Samuel 17?", hints:["No usó espada ni lanza","Usó un arma simple de pastor","Una piedra y un instrumento de cuero"], a:"Honda y una piedra" },
  { id:229, cat:"Objetos", q:"¿Qué objeto hizo Moisés para que los israelitas picados vivieran según Números 21?", hints:["Dios le ordenó ponerlo en un asta","Quien miraba a este objeto quedaba vivo","Jesús lo menciona en Juan 3 como figura de sí mismo"], a:"Una serpiente de bronce" },
  { id:230, cat:"Objetos", q:"¿Qué tipo de armadura espiritual menciona Pablo en Efesios 6?", hints:["Incluye el cinturón de la verdad","Incluye el escudo de la fe","Termina con la espada del Espíritu que es la Palabra"], a:"Cinturón, coraza, calzado, escudo, yelmo y espada" },
  { id:231, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años vivió Abraham según Génesis 25?", hints:["Tuvo a Isaac cuando tenía 100 años","Murió en buena vejez","Vivió 175 años"], a:"175 años" },
  { id:232, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años llevan enferma la mujer encorvada que Jesús sanó en la sinagoga según Lucas 13?", hints:["Un espíritu de enfermedad la tenía encorvada","No podía enderezarse de ninguna manera","Llevaba 18 años enferma"], a:"18 años" },
  { id:233, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos talentos de oro trajo la reina de Sabá a Salomón según 1 Reyes 10?", hints:["También le trajo especias y piedras preciosas","Nunca más llegaron tantas especias","La cantidad fue 120 talentos de oro"], a:"120 talentos de oro" },
  { id:234, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos siclos de plata pagó David por la era de Arauna según 2 Samuel 24?", hints:["El rey no quería ofrecer a Dios lo que no le costaba nada","Arauna ofreció dársela gratis","David pagó 50 siclos de plata"], a:"50 siclos de plata" },
  { id:235, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuánto tiempo duró la sequía que anunció Elías según Santiago 5:17?", hints:["Santiago lo menciona como ejemplo de oración eficaz","Elías era un hombre como nosotros","Duró tres años y seis meses"], a:"3 años y 6 meses" },
  { id:236, cat:"Personas", q:"¿Quién fue Bartimeo según Marcos 10?", hints:["Era ciego y mendigo","Estaba sentado junto al camino en Jericó","Clamó: Jesús hijo de David ten misericordia de mí"], a:"Un mendigo ciego de Jericó que Jesús sanó" },
  { id:237, cat:"Personas", q:"¿Quién era Andrés en relación con Pedro según Mateo 4?", hints:["Era pescador en el Mar de Galilea","Jesús los llamó a ser pescadores de hombres","Era el hermano de Pedro"], a:"El hermano de Pedro" },
  { id:238, cat:"Personas", q:"¿Quién fue el primer mártir cristiano mencionado en Hechos 7?", hints:["Era uno de los siete diáconos","Fue apedreado por el Sanedrín","Saulo cuidaba las ropas de los que lo apedreaban"], a:"Esteban" },
  { id:239, cat:"Personas", q:"¿Quién acompañó a Pablo en su primer viaje misionero según Hechos 13?", hints:["Era primo de Marcos","Su nombre original era José","El nombre significa hijo de consolación"], a:"Bernabé" },
  { id:240, cat:"Personas", q:"¿Quién fue el discípulo que reemplazó a Judas Iscariote según Hechos 1?", hints:["La elección fue entre dos candidatos","Echaron suertes","El otro candidato se llamaba José Barsabás"], a:"Matías" },
  { id:241, cat:"Lugares", q:"¿En qué ciudad fue coronado Salomón rey según 1 Reyes 1?", hints:["Era una fuente cerca de Jerusalén","El sacerdote Sadoc y el profeta Natán lo ungieron allí","Su nombre empieza con G"], a:"Gihón" },
  { id:242, cat:"Lugares", q:"¿En qué ciudad fue llevada cautiva el arca del pacto según 1 Samuel 5?", hints:["Los filisteos la pusieron junto a su ídolo Dagón","Dagón cayó dos veces ante el arca","Los habitantes fueron afligidos con tumores"], a:"Asdod" },
  { id:243, cat:"Lugares", q:"¿En qué ciudad de Grecia predicó Pablo en el Areópago según Hechos 17?", hints:["Mencionó al Dios no conocido","Algunos se burlaron cuando habló de la resurrección","Era la ciudad de los filósofos griegos"], a:"Atenas" },
  { id:244, cat:"Lugares", q:"¿En qué ciudad de Macedonia fundó Pablo una iglesia según Hechos 16?", hints:["Allí bautizó a Lidia vendedora de púrpura","Pablo y Silas fueron encarcelados allí","Un terremoto abrió las puertas de la cárcel"], a:"Filipos" },
  { id:245, cat:"Lugares", q:"¿En qué isla quedó varado Pablo después de un naufragio según Hechos 28?", hints:["Los nativos mostraron mucha humanidad","Una víbora se prendió en la mano de Pablo","Pablo sanó al padre del hombre principal de la isla"], a:"Malta" },
  { id:246, cat:"Números", q:"¿Cuántos años vivió Matusalén según Génesis 5?", hints:["Es el hombre más longevo de la Biblia","Vivió más de 900 años","Su nombre es sinónimo de vejez extrema"], a:"969 años" },
  { id:247, cat:"Números", q:"¿Cuántos días duró la lluvia del diluvio según Génesis 7?", hints:["Es un número muy simbólico en la Biblia","Moisés ayunó este número de días","Es múltiplo de 8 y de 5"], a:"40 días y 40 noches" },
  { id:248, cat:"Números", q:"¿Cuántos apóstoles eligió Jesús según Lucas 6?", hints:["El número corresponde a las tribus de Israel","Uno lo traicionó","Son una docena"], a:"12 apóstoles" },
  { id:249, cat:"Números", q:"¿Cuántos libros tiene el Nuevo Testamento?", hints:["Comienzan con los cuatro evangelios","Terminan con el Apocalipsis","El número es 27"], a:"27 libros" },
  { id:250, cat:"Números", q:"¿Cuántos evangelios hay en el Nuevo Testamento?", hints:["Cada uno narra la vida de Jesús","Se llaman Mateo Marcos Lucas y Juan","El número es 4"], a:"4 evangelios" },
  { id:251, cat:"Animales", q:"¿Qué tipo de aves le enviaba Dios a Elías con comida según 1 Reyes 17?", hints:["Le traían pan y carne por la mañana y por la tarde","El arroyo se llamaba Querit","Eran aves negras"], a:"Cuervos" },
  { id:252, cat:"Animales", q:"¿Qué tipo de animales usó Sansón para incendiar los campos de los filisteos según Jueces 15?", hints:["Capturó 300 de ellos","Les ató antorchas en las colas","Las soltó en los sembradíos"], a:"Zorras (o chacales)" },
  { id:253, cat:"Plantas", q:"¿De qué árbol tomaron hojas Adán y Eva para cubrirse según Génesis 3?", hints:["Usaron sus hojas para hacerse delantales","Es un árbol de fruta conocida","Sus hojas son grandes y anchas"], a:"La higuera" },
  { id:254, cat:"Plantas", q:"¿Con qué planta protegió Dios a Jonás del sol según Jonás 4?", hints:["Creció en una noche sobre Jonás","Jonás se alegró mucho por ella","Al día siguiente Dios preparó un gusano que la atacó"], a:"Una calabacera o planta enredadera" },
  { id:255, cat:"Objetos", q:"¿Con qué objeto mató Jael al general Sísara según Jueces 4?", hints:["Era un instrumento de construcción","Lo clavó en la sien de Sísara mientras dormía","Era una estaca de tienda de campaña"], a:"Una estaca de tienda y un mazo" },
  { id:256, cat:"Objetos", q:"¿Qué instrumento musical usó María para celebrar el cruce del Mar Rojo según Éxodo 15?", hints:["Era un instrumento de percusión","María tomó este instrumento y dirigió a las mujeres","Es un instrumento que se toca con las manos"], a:"La pandereta" },
  { id:257, cat:"Eventos", q:"¿Qué ocurrió con los tres amigos de Daniel en el horno de fuego según Daniel 3?", hints:["El rey lo había calentado siete veces más","El rey vio a un cuarto personaje en el horno","Salieron sin que su ropa oliera a humo"], a:"Salieron ilesos y sin olor a humo" },
  { id:258, cat:"Eventos", q:"¿Qué sucedió con el sol cuando Josué peleó contra los amorreos según Josué 10?", hints:["Josué habló al sol y a la luna","No hubo día semejante antes ni después","El sol se detuvo en medio del cielo"], a:"El sol se detuvo" },
  { id:259, cat:"Eventos", q:"¿Qué pasó cuando Pablo y Silas oraban en la cárcel de Filipos según Hechos 16?", hints:["Era a medianoche","Cantaban himnos y los presos los escuchaban","Un terremoto abrió las puertas y soltó las cadenas"], a:"Un terremoto sacudió la cárcel y las puertas se abrieron" },
  { id:260, cat:"Eventos", q:"¿Qué ocurrió en la Transfiguración de Jesús según Mateo 17?", hints:["Ocurrió en un monte alto","Su rostro resplandeció como el sol","Aparecieron Moisés y Elías hablando con él"], a:"Jesús se transfiguró: su rostro brilló y aparecieron Moisés y Elías" },
  { id:261, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años vivió Isaac según Génesis 35?", hints:["Vivió más que su padre Abraham","Enterró a su padre junto con su hermano Ismael","Vivió 180 años"], a:"180 años" },
  { id:262, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años tardó Salomón en construir el templo según 1 Reyes 6?", hints:["Comenzó a construirlo en el cuarto año de su reinado","Lo terminó en el undécimo año","El número de años es 7"], a:"7 años" },
  { id:263, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántas ciudades de refugio estableció Josué según Josué 20?", hints:["Tres al este del Jordán y tres al oeste","Eran para quien matara a alguien sin intención","El número total es seis"], a:"6 ciudades de refugio" },
  { id:264, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuánto pesaba la punta de la lanza de Goliat según 1 Samuel 17?", hints:["El asta era como el rodillo de un telar","La punta era de hierro","Pesaba 600 siclos de hierro"], a:"600 siclos de hierro" },
  { id:265, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años reinó Asa sobre Judá según 1 Reyes 15?", hints:["Era bisnieto de Salomón","Quitó a los sodomitas y a los ídolos de la tierra","Reinó 41 años"], a:"41 años" },
  { id:266, cat:"Personas", q:"¿Quién fue la ramera de Jericó que escondió a los espías de Josué según Josué 2?", hints:["Colgó un cordón de grana en la ventana","Su familia fue preservada cuando cayó Jericó","Aparece en la genealogía de Jesús en Mateo 1"], a:"Rahab" },
  { id:267, cat:"Personas", q:"¿Quién fue el único jueza de Israel mencionada en Jueces 4?", hints:["Animó a Barac a luchar contra Sísara","Era profetisa y juzgaba bajo una palmera","Su nombre significa abeja en hebreo"], a:"Débora" },
  { id:268, cat:"Personas", q:"¿Quién fue la mujer moabita que acompañó a su suegra Noemí a Belén?", hints:["Dijo: donde tú mueras moriré yo","Espigó en los campos de Booz","Llegó a ser bisabuela del rey David"], a:"Rut" },
  { id:269, cat:"Personas", q:"¿Quién fue el sucesor de Moisés para entrar a la tierra prometida?", hints:["Era de la tribu de Efraín","Fue uno de los 12 espías que dieron buen informe","Su nombre original era Oseas"], a:"Josué" },
  { id:270, cat:"Personas", q:"¿Quién fue el profeta que confrontó al rey David por Urías según 2 Samuel 12?", hints:["Le contó la parábola de la oveja robada","David se arrepintió al escucharle","Su nombre empieza con N"], a:"Natán" },
  { id:271, cat:"Lugares", q:"¿En qué jardín vivieron Adán y Eva según Génesis 2?", hints:["Dios lo plantó en el oriente","Tenía un árbol del bien y del mal","Fue custodiado por querubines al salir"], a:"Edén" },
  { id:272, cat:"Lugares", q:"¿En qué monte recibió Moisés los mandamientos según Éxodo 19?", hints:["También se llama Horeb","Está en la península del Sinaí","Dios habló desde una nube densa sobre él"], a:"Monte Sinaí" },
  { id:273, cat:"Lugares", q:"¿Qué mar dividió Moisés con su vara según Éxodo 14?", hints:["El ejército de Faraón fue ahogado en él","Está entre África y Arabia","Israel cruzó en seco"], a:"Mar Rojo" },
  { id:274, cat:"Lugares", q:"¿En qué lugar fue arrestado Jesús según Juan 18?", hints:["Era un huerto al pie del Monte de los Olivos","Allí oró antes de ser arrestado","Su nombre significa prensa de aceite"], a:"Getsemaní" },
  { id:275, cat:"Lugares", q:"¿En qué lugar fue crucificado Jesús según Juan 19?", hints:["Significa lugar de la calavera en hebreo","También se conoce como Calvario en latín","Estaba fuera de las murallas de Jerusalén"], a:"Gólgota" },
  { id:276, cat:"Números", q:"¿Cuántos mandamientos recibió Moisés en el Sinaí según Éxodo 20?", hints:["Escritos en dos tablas de piedra","Corresponden a los dedos de dos manos","Están en Éxodo 20"], a:"10 mandamientos" },
  { id:277, cat:"Números", q:"¿Cuántos años estuvo Israel en el desierto según Números 14?", hints:["Un año por cada día que los espías exploraron","Los espías exploraron 40 días","El número es el mismo que los días de lluvia"], a:"40 años" },
  { id:278, cat:"Números", q:"¿Cuántos hijos tuvo Jacob según Génesis?", hints:["Formaron las tribus de Israel","Uno fue vendido como esclavo","El número es igual al de los apóstoles de Jesús"], a:"12 hijos" },
  { id:279, cat:"Números", q:"¿Cuántos días estuvo Jesús siendo tentado en el desierto según Mateo 4?", hints:["Ayunó todo ese tiempo","Satanás lo tentó tres veces","El número es 40"], a:"40 días" },
  { id:280, cat:"Números", q:"¿Cuántos panes y peces usó Jesús para alimentar a 5,000 según Juan 6?", hints:["Un muchacho los tenía","Sobraron 12 canastas","Eran 5 panes y 2 peces"], a:"5 panes y 2 peces" },
  { id:281, cat:"Animales", q:"¿Qué animal habló con Balaam según Números 22?", hints:["Dios le abrió la boca para hablar","Vio al ángel del Señor antes que su amo","Era el animal que Balaam montaba"], a:"La asna de Balaam" },
  { id:282, cat:"Plantas", q:"¿Desde qué planta habló Dios a Moisés según Éxodo 3?", hints:["Ardía y no se consumía","Dios habló desde ella","Estaba en el monte Horeb"], a:"La zarza ardiente" },
  { id:283, cat:"Objetos", q:"¿Qué contenía el Arca del Pacto según Hebreos 9?", hints:["Tres objetos sagrados estaban dentro","Uno era la vara que floreció","Otro era el maná guardado"], a:"Las tablas de la ley, la vara de Aarón y el maná" },
  { id:284, cat:"Eventos", q:"¿Cuántas plagas envió Dios sobre Egipto según Éxodo?", hints:["La última fue la muerte de los primogénitos","La primera fue el agua en sangre","El número es igual a los dedos de dos manos"], a:"10 plagas" },
  { id:285, cat:"Eventos", q:"¿Qué ocurrió 50 días después de la Pascua según Hechos 2?", hints:["Los discípulos estaban reunidos en un lugar","El Espíritu Santo descendió como lenguas de fuego","Pedro predicó y 3,000 personas se convirtieron"], a:"Pentecostés: el Espíritu Santo descendió" },
  { id:286, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años vivió José según Génesis 50?", hints:["Vio a los hijos de Maquir hijo de Manasés","Murió en Egipto y fue embalsamado","Vivió 110 años"], a:"110 años" },
  { id:287, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuánto tiempo estuvo el arca del pacto en casa de Obed-edom según 2 Samuel 6?", hints:["David no se atrevió a llevarla a Jerusalén después de la muerte de Uzza","Dios bendijo a Obed-edom durante ese tiempo","El número es tres meses"], a:"3 meses" },
  { id:288, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años reinó Manasés rey de Judá según 2 Reyes 21?", hints:["Era hijo del rey Ezequías","Hizo más mal que los amorreos","Reinó 55 años"], a:"55 años" },
  { id:289, cat:"Personas", q:"¿Quién fue el primer rey de Israel según 1 Samuel 10?", hints:["Era de la tribu de Benjamín","Medía más de dos metros","Samuel lo ungió como rey"], a:"Saúl" },
  { id:290, cat:"Personas", q:"¿Quién fue la madre de Samuel que lo dedicó a Dios desde antes de nacer?", hints:["Era estéril y oró con amargura en el tabernáculo","El sacerdote Elí pensó que estaba borracha","Cuando Samuel nació lo llevó al tabernáculo en Silo"], a:"Ana" },
  { id:291, cat:"Personas", q:"¿Quién fue el rey que dividió el reino de Israel en dos según 1 Reyes 12?", hints:["Era hijo de Salomón","Respondió duramente al pueblo cuando pidió alivio","Las 10 tribus del norte se separaron bajo Jeroboam"], a:"Roboam" },
  { id:292, cat:"Personas", q:"¿Quién fue el profeta que ungió a David como rey según 1 Samuel 16?", hints:["Dios lo envió a la casa de Isaí en Belén","Pensó que el elegido era Eliab por su apariencia","Su nombre también es el nombre de un libro bíblico"], a:"Samuel" },
  { id:293, cat:"Personas", q:"¿Quién fue el fariseo que visitó a Jesús de noche según Juan 3?", hints:["Era principal entre los judíos","Jesús le habló del nuevo nacimiento","Después defendió a Jesús en el Sanedrín"], a:"Nicodemo" },
  { id:294, cat:"Personas", q:"¿Quién era el recaudador de impuestos que subió a un árbol para ver a Jesús según Lucas 19?", hints:["Era bajo de estatura","Subió a un sicómoro","Jesús fue a su casa ese día"], a:"Zaqueo" },
  { id:295, cat:"Eventos", q:"¿Qué ocurrió cuando Elías oró sobre el hijo muerto de la viuda de Sarepta según 1 Reyes 17?", hints:["El niño había enfermado y muerto","Elías oró sobre él tres veces","El niño volvió a la vida"], a:"El niño revivió" },
  { id:296, cat:"Eventos", q:"¿Qué señal puso Dios en el cielo después del diluvio según Génesis 9?", hints:["Era una señal del pacto entre Dios y Noé","Aparece cuando llueve","Tiene varios colores"], a:"El arcoíris" },
  { id:297, cat:"Desafío", q:"⚡ DESAFÍO: ¿A cuántas personas se apareció Jesús resucitado en el mayor testimonio según 1 Corintios 15?", hints:["Pablo los cita como testigos vivos","La mayoría aún vivía cuando Pablo escribió","El número fue más de 500 hermanos"], a:"Más de 500 hermanos a la vez" },
  { id:298, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos sellos tiene el rollo en Apocalipsis 5?", hints:["Solo el Cordero pudo abrirlos","Cada sello abierto trajo un evento","El número es siete"], a:"7 sellos" },
  { id:299, cat:"Desafío", q:"⚡ DESAFÍO: ¿Qué número de bestia menciona Apocalipsis 13?", hints:["Requiere sabiduría para entenderlo","Es el número del hombre","El número es 666"], a:"666" },
  { id:300, cat:"Desafío", q:"⚡ DESAFÍO: ¿Cuántos años llevaba en cama el paralítico Eneas que Pedro sanó según Hechos 9?", hints:["Su nombre era Eneas","Pedro le dijo: Eneas Jesucristo te sana","Llevaba 8 años en cama"], a:"8 años" },
];
